...
the experimental [layer-less](#no-strict-layer-structure) structure.
...
1. try-and-error
    ...
    is more a side feature in form of the [Reduction](#reduction), which
...
- **neurons**
    ...
    [spikin neural networks](#spiking-neural-network)
...
![Workflow](information_processing2.svg)
...
like written in the [growing-process](#growing-process). Each connection
...
[output-processing](#output) below.
...
[spiking neural networks](#spiking-neural-network), because different
timeframes of the spike and it cool-down also means a different amount of active synapse.

![Workflow](information_processing.svg)
...
![Workflow](output_processing.svg)
...
![multi-threading](multithreading.svg)
...
![Connection-distance](connection_distance.svg)
...
![Connection-distance](connection_distance2.svg)
